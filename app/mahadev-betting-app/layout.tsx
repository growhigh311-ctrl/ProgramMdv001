...
export const metadata: Metadata = {
  ...
  description:
    "Download the official Mahadev Betting App for Android & iOS. Live cricket betting, casino games, UPI deposits & instant withdrawals on mahadev.guru.",
  alternates: { canonical: "https://mahadev.guru/mahadev-betting-app" },
  openGraph: {
    ...
    url: "https://mahadev.guru/mahadev-betting-app",
